package hu.marcibbx.JEEzusom.webservice.filter;
...
@WebFilter(filterName = "JEEzusomCrossOriginRequestFilter", urlPatterns = { "/*" })
public class JEEzusomCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(JEEzusomCrossOriginRequestFilter.class);
