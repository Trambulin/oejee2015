...
INSERT INTO account (account_id, first_name, last_name, name, email, password, is_activated, warn_count, ban_expire) 
	VALUES (2, 'Márton', 'Bognár', 'BMarci', 'marciemail@jeezusom.com', 'ezisnagyontitkos', TRUE, 3, NULL);
INSERT INTO account (account_id, first_name, last_name, name, email, password, is_activated, warn_count, ban_expire) 
	VALUES (3, 'Dániel', 'Takács', 'TDani', 'daniemail@jeezusom.com', 'szintennagyontitkos', TRUE, 1, '2015/12/24');
...
INSERT INTO character_base (character_id, name, experience, race_id, is_male, money_amount, account_id) 
	VALUES (3, 'Wainwright', 40000, 4, TRUE, 5000, 3);
