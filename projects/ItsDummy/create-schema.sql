...
CREATE INDEX I_CARTYPE_MODEL ON cartype (model);
...
CREATE INDEX I_CAR_PRODUCTION_DATE ON car (production_date);
...
CREATE UNIQUE INDEX UI_CUSTOMER_NAME ON customer USING btree (login_name);
