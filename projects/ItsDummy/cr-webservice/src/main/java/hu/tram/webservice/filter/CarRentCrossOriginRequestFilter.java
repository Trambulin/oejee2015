package hu.tram.webservice.filter;
...
@WebFilter(filterName = "CarRentCrossOriginRequestFilter", urlPatterns = { "/*" })
public class CarRentCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(CarRentCrossOriginRequestFilter.class);
