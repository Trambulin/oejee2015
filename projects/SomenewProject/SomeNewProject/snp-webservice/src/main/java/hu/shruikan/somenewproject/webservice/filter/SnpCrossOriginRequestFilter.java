package hu.shruikan.somenewproject.webservice.filter;
...
@WebFilter(filterName = "SnpCrossOriginRequestFilter", urlPatterns = { "/*" })
public class SnpCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(SnpCrossOriginRequestFilter.class);
