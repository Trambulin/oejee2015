package hu.morkalla.gymproject.webservice.filter;
...
@WebFilter(filterName = "GYMCrossOriginRequestFilter", urlPatterns = { "/*" })
public class GYMCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(GYMCrossOriginRequestFilter.class);
