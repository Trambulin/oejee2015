...
psql -d mygymdb -h localhost -p 5432 -U postgres -f create-schema.sql
psql -d mygymdb -h localhost -p 5432 -U postgres -f grant-access.sql
psql -d mygymdb -h localhost -p 5432 -U postgres -f initial-data.sql