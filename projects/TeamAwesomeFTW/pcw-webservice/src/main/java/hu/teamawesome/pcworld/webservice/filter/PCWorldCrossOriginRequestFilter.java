package hu.teamawesome.pcworld.webservice.filter;
...
@WebFilter(filterName = "PCWorldCrossOriginRequestFilter", urlPatterns = { "/*" })
public class PCWorldCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(PCWorldCrossOriginRequestFilter.class);
