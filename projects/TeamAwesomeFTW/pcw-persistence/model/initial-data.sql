...
INSERT INTO product_type (pdt_id, pdt_name) VALUES (0, U&'Billentyűzet');
INSERT INTO product_type (pdt_id, pdt_name) VALUES (1, U&'Egér');
INSERT INTO product_type (pdt_id, pdt_name) VALUES (2, U&'Joystick');
INSERT INTO product_type (pdt_id, pdt_name) VALUES (3, U&'Memória - RAM');
INSERT INTO product_type (pdt_id, pdt_name) VALUES (4, U&'Memória kártya, pendrive');
INSERT INTO product_type (pdt_id, pdt_name) VALUES (5, U&'Videókártya');
...
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(0, U&'LOGITECH Keyboard K120 USB HUN fekete billentyűzet', '', 24, 3810, 2, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(0, U&'GENIUS Imperator GX gamer USB HUN fekete billentyűzet', '', 24, 8941, 3, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(0, U&'GIGABYTE GK-K6150 Slim HUN USB fekete billentyűzet', '', 24, 2540, 0, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(0, U&'MICROSOFT Wired Keyboard 200 hun USB fekete billentyűzet', '', 36, 4318, 4, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(1, U&'CORSAIR Raptor M30 optikai Gamer 4000DPI USB fekete egér', '', 36, 12243, 7, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(1, U&'LOGITECH G100S Gaming 2500dpi optikai USB egér', '', 26, 12040, 2, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(1, U&'GIGABYTE GM-M6880-V2 1600dpi gamer lézeres fekete USB egér', '', 26, 4115, 0, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(2, U&'LOGITECH F710 Rumblepad rádiós vibra feedback gamepad', '', 26, 13132, 2, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(2, U&'LOGITECH Driving Force GT Force Feedback kormány PC/Playstation3', '', 26, 42062, 2, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
...
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(4, U&'CORSAIR 16GB Flash Survivor Stealth CMFSS3-16GB fémtokos USB3.0 pendrive', '', 60, 10795, 7, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(4, U&'KINGSTON 1.0TB HyperX Predator DTHXP30/1TB USB3.0 pendrive', '', 60, 202413, 9, 2);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(4, U&'KINGSTON 8GB DT100G3/8GB USB3.0 pendrive', '', 36, 2184, 9, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(5, U&'ASUS AMD Radeon R7 370 4096MB D5 STRIX-R7370-DC2OC-4GD5-GAMING PCI-E3.0 videokártya', '', 36, 57658, 12, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(5, U&'MSI AMD Radeon R9 FURY X 4096MB HBM R9 FURY X 4G PCI-E3.0 videokártya', '', 36, 230683, 1, 2);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(5, U&'GIGABYTE AMD Radeon R9 270X 2048MB D5 GV-R927XOC-2GD PCI-E3.0 videokártya', '', 36, 55804, 0, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(5, U&'ASUS GeForce GTX TITAN X 12288MB D5 GTXTITANX-12GD5 PCI-E3.0 videokártya', '', 36, 345567, 12, 2);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(5, U&'GIGABYTE GeForce GTX960 2048MB D5 GV-N960WF2OC-2GD PCI-E3.0 videokártya', '', 36, 62306, 0, 1);
INSERT INTO supplier (sup_product_type, sup_name, sup_description, sup_warranty, sup_price, spr_manufacturer_id, spr_shipping_days)
	VALUES(5, U&'MSI GeForce GT730 2048MB D3 N730K-2GD3/OC PCI-E3.0 videokártya', '', 36, 20980, 1, 1);
...
INSERT INTO customer (ctm_email, ctm_password, ctm_joined, ctm_lastname, ctm_firstname, ctm_address, ctm_telephone)
	VALUES ('admin@vbstudio.hu', '5f4dcc3b5aa765d61d8327deb882cf99', '2015-10-13', U&'Vecsey', U&'Balázs', '1234 Budapest, Balage u. 8', '0630-123-4567');
