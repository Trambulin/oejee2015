...
INSERT INTO notification(notification_id,condominium_owner_id,notification_message,notification_date,notification_answer,notification_completed) VALUES (1,2,'Téves','1990-02-20','Rendben',1);
INSERT INTO notification(notification_id,condominium_owner_id,notification_message,notification_date,notification_answer,notification_completed) VALUES (2,1,'Megjavult','1991-09-30','Oké',1);
INSERT INTO notification(notification_id,condominium_owner_id,notification_message,notification_date,notification_answer,notification_completed) VALUES (3,3,'Még Rossz','1988-04-11','Sietünk',0);

INSERT INTO repair_notification(repair_notification_id,repair_id,notification_id) VALUES (1,2,3);
INSERT INTO repair_notification(repair_notification_id,repair_id,notification_id) VALUES (2,1,2);
INSERT INTO repair_notification(repair_notification_id,repair_id,notification_id) VALUES (3,1,3);