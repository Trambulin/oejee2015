package hu.nik.condominium.webservice.filter;
...
@WebFilter(filterName = "OwnerCrossOriginRequestFilter", urlPatterns = { "/*" })
public class OwnerCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(OwnerCrossOriginRequestFilter.class);
